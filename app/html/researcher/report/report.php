...
$result = $connection->getCompanyDetails($companyid);
$clogo = $result['clogo'];
            ...
            <div class="report-submit-form">
                ...
                <div class="form">
                    ...
                    <div class="field">
                        ...
                        <div class="text">
                            <p>When did it first discoverd?</p>
                        </div>
                        <div class="input">
                            <p><?php echo $reporttime;?></p>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="text">
                            <p>What is the status of this report?</p>
                        </div>
                        <div class="input">
                            <p><?php echo $status;?></p>
                        </div>
                    ...
                    <div class="field">
                        ...
                        <div class="text">
                            <p>What is the reward for this report?</p>
                        </div>
                        <div class="input">
                            <p><?php echo $reward;?></p>
                        </div>
